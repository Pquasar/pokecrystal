...
; BATTLE_ANIM_OBJ_ENERGY_BALL
	battleanimobj RELATIVE_X | X_FLIP, $a0, BATTLE_ANIM_FRAMESET_BARRAGE_BALL, BATTLE_ANIM_FUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_GREEN, BATTLE_ANIM_GFX_EGG 
; BATTLE_ANIM_OBJ_SMALL_ICE
	battleanimobj RELATIVE_X, $ff, BATTLE_ANIM_FRAMESET_SMALL_ROCK, BATTLE_ANIM_FUNC_DROP, PAL_BATTLE_OB_BLUE, BATTLE_ANIM_GFX_ROCKS
; BATTLE_ANIM_OBJ_BIG_ICE	
	battleanimobj RELATIVE_X, $ff, BATTLE_ANIM_FRAMESET_BIG_ROCK, BATTLE_ANIM_FUNC_DROP, PAL_BATTLE_OB_BLUE, BATTLE_ANIM_GFX_ROCKS 
; BATTLE_ANIM_OBJ_EARTH_POWER	
	battleanimobj RELATIVE_X, $b4, BATTLE_ANIM_FRAMESET_HYDRO_PUMP, BATTLE_ANIM_FUNC_NULL, PAL_BATTLE_OB_RED, BATTLE_ANIM_GFX_WATER 
; BATTLE_ANIM_OBJ_POWER_GEM	
	battleanimobj RELATIVE_X, $90, BATTLE_ANIM_FRAMESET_ICE_BEAM, BATTLE_ANIM_FUNC_USER_TO_TARGET, PAL_BATTLE_OB_BROWN, BATTLE_ANIM_GFX_ICE 
...
; BATTLE_ANIM_OBJ_STEALTH_ROCK
	battleanimobj RELATIVE_X | X_FLIP, $70, BATTLE_ANIM_FRAMESET_SMALL_ROCK, BATTLE_ANIM_FUNC_SPIKES, PAL_BATTLE_OB_BROWN, BATTLE_ANIM_GFX_ROCKS
