...
; BattleTowerMons group 1
	...
	db ESPEON
	db LEFTOVERS
	db SUCKER_PUNCH, PSYCHIC_M, OUTRAGE, TOXIC
	dw 0 ; OT ID
	bigdt 1000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db UMBREON
	db GOLD_BERRY
	db SHADOW_BALL, IRON_TAIL, OUTRAGE, TOXIC
	dw 0 ; OT ID
	bigdt 1000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db AERODACTYL
	db LEFTOVERS
	db HYPER_BEAM, SLUDGE_BOMB, EARTHQUAKE, CRUNCH
	dw 0 ; OT ID
	bigdt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db EXEGGUTOR
	db KINGS_ROCK
	db TOXIC, GIGA_DRAIN, THIEF, PSYWAVE
	dw 0 ; OT ID
	bigdt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db TAUROS
	db KINGS_ROCK
	db HEADBUTT, SWAGGER, SWORDS_DANCE, ICY_WIND
	dw 0 ; OT ID
	bigdt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db MR__MIME
	db QUICK_CLAW
	db TOXIC, OUTRAGE, FIRE_PUNCH, HEADBUTT
	dw 0 ; OT ID
	bigdt 1000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 2
	...
	db UMBREON
	db LEFTOVERS
	db PROTECT, TOXIC, SUCKER_PUNCH, ATTRACT
	dw 0 ; OT ID
	bigdt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db STARMIE
	db GOLD_BERRY
	db RECOVER, PSYCHIC_M, SURF, OUTRAGE
	dw 0 ; OT ID
	bigdt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db GYARADOS
	db MIRACLEBERRY
	db HYPER_BEAM, OVERHEAT, THUNDERBOLT, FIRE_BLAST
	dw 0 ; OT ID
	bigdt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db ALAKAZAM
	db BERRY_JUICE
	db PSYCHIC_M, OUTRAGE, TOXIC, THUNDERPUNCH
	dw 0 ; OT ID
	bigdt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db AERODACTYL
	db GOLD_BERRY
	db REST, HYPER_BEAM, EARTHQUAKE, OVERHEAT
	dw 0 ; OT ID
	bigdt 8000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db BLISSEY
	db BRIGHTPOWDER
	db PSYCHIC_M, DRILL_PECK, SOFTBOILED, COUNTER
	dw 0 ; OT ID
	bigdt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db HITMONCHAN
	db GOLD_BERRY
	db THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, ROCK_SLIDE
	dw 0 ; OT ID
	bigdt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db WIGGLYTUFF
	db PINK_BOW
	db PSYCHIC_M, SWAGGER, OUTRAGE, HEADBUTT
	dw 0 ; OT ID
	bigdt 8000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 3
	...
	db JOLTEON
	db MIRACLEBERRY
	db THUNDERBOLT, THUNDER_WAVE, ROAR, SUCKER_PUNCH
	dw 0 ; OT ID
	bigdt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db POLIWRATH
	db BRIGHTPOWDER
	db CALM_MIND, SURF, PSYWAVE, DRILL_PECK
	dw 0 ; OT ID
	bigdt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db DUGTRIO
	db KINGS_ROCK
	db EARTHQUAKE, SLUDGE_BOMB, SLASH, SUCKER_PUNCH
	dw 0 ; OT ID
	bigdt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db BELLOSSOM
	db BRIGHTPOWDER
	db GIGA_DRAIN, SUNNY_DAY, SOLARBEAM, CALM_MIND
	dw 0 ; OT ID
	bigdt 27000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db LAPRAS
	db LEFTOVERS
	db RAIN_DANCE, HYDRO_PUMP, ICY_WIND, STRENGTH
	dw 0 ; OT ID
	bigdt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db ESPEON
	db MIRACLEBERRY
	db PSYWAVE, SWIFT, TOXIC, OUTRAGE
	dw 0 ; OT ID
	bigdt 27000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db GENGAR
	db GOLD_BERRY
	db THIEF, TACKLE, NIGHT_SHADE, GIGA_DRAIN
	dw 0 ; OT ID
	bigdt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db URSARING
	db GOLD_BERRY
	db HEADBUTT, PROTECT, ROAR, CRUNCH
	dw 0 ; OT ID
	bigdt 27000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db PRIMEAPE
	db MIRACLEBERRY
	db LOW_KICK, JUMP_KICK, REVERSAL, FOCUS_ENERGY
	dw 0 ; OT ID
	bigdt 27000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 4
	...
	db KINGDRA
	db LEFTOVERS
	db SURF, ACROBATICS, HYPER_BEAM, BLIZZARD
	dw 0 ; OT ID
	bigdt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db SNORLAX
	db QUICK_CLAW
	db ATTRACT, BODY_SLAM, OUTRAGE, EARTHQUAKE
	dw 0 ; OT ID
	bigdt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db GOLEM
	db FOCUS_BAND
	db EXPLOSION, EARTHQUAKE, ROCK_SLIDE, ROCK_SLIDE
	dw 0 ; OT ID
	bigdt 64000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db DUGTRIO
	db KINGS_ROCK
	db EARTHQUAKE, HYPER_BEAM, SLUDGE_BOMB, SUCKER_PUNCH
	dw 0 ; OT ID
	bigdt 64000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db ARCANINE
	db CHARCOAL
	db TACKLE, CRUNCH, BODY_SLAM, ROAR
	dw 0 ; OT ID
	bigdt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db OMASTAR
	db GOLD_BERRY
	db CURSE, HYDRO_PUMP, ANCIENTPOWER, ROCK_SMASH
	dw 0 ; OT ID
	bigdt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db CHARIZARD
	db KINGS_ROCK
	db FIRE_SPIN, OVERHEAT, FLY, SLASH
	dw 0 ; OT ID
	bigdt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db EXEGGUTOR
	db BRIGHTPOWDER
	db TACKLE, ZEN_HEADBUTT, OUTRAGE, PSYWAVE
	dw 0 ; OT ID
	bigdt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db HYPNO
	db BRIGHTPOWDER
	db PSYWAVE, THUNDERPUNCH, HEADBUTT, DISABLE
	dw 0 ; OT ID
	bigdt 64000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db MUK
	db QUICK_CLAW
	db SCREECH, TOXIC, SLUDGE, TACKLE
	dw 0 ; OT ID
	bigdt 64000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 5
	...
	db KINGDRA
	db GOLD_BERRY
	db SURF, HYPER_BEAM, BLIZZARD, ACROBATICS
	dw 0 ; OT ID
	bigdt 125000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db SNORLAX
	db LEFTOVERS
	db HYPER_BEAM, EARTHQUAKE, SURF, OUTRAGE
	dw 0 ; OT ID
	bigdt 125000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db SCIZOR
	db LEFTOVERS
	db HYPER_BEAM, SLASH, AGILITY, ROOST
	dw 0 ; OT ID
	bigdt 125000 ; Exp
	; Stat exp
	bigdw 45000
...
; BattleTowerMons group 6
	...
	db KINGDRA
	db LEFTOVERS
	db ACROBATICS, SURF, HYPER_BEAM, BLIZZARD
	dw 0 ; OT ID
	bigdt 216000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db UMBREON
	db GOLD_BERRY
	db SUCKER_PUNCH, MOONLIGHT, PSYCHIC_M, FAINT_ATTACK
	dw 0 ; OT ID
	bigdt 216000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db GOLEM
	db BRIGHTPOWDER
	db EXPLOSION, EARTHQUAKE, FIRE_PUNCH, IRON_DEFENSE
	dw 0 ; OT ID
	bigdt 216000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 7
	...
	db VAPOREON
	db LEFTOVERS
	db BLIZZARD, SHADOW_BALL, SURF, SUCKER_PUNCH
	dw 0 ; OT ID
	bigdt 343000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db UMBREON
	db GOLD_BERRY
	db FAINT_ATTACK, MOONLIGHT, OUTRAGE, TOXIC
	dw 0 ; OT ID
	bigdt 343000 ; Exp
	; Stat exp
	bigdw 54000
	...
	db HITMONLEE
	db FOCUS_BAND
	db REVERSAL, ENDURE, BODY_SLAM, FAKE_OUT
	dw 0 ; OT ID
	bigdt 343000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 8
	...
	db KINGDRA
	db MINT_BERRY
	db REST, SURF, BLIZZARD, ACROBATICS
	dw 0 ; OT ID
	bigdt 512000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db SKARMORY
	db QUICK_CLAW
	db STEEL_WING, FLY, SUCKER_PUNCH, TOXIC
	dw 0 ; OT ID
	bigdt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db DUGTRIO
	db SCOPE_LENS
	db SLASH, EARTHQUAKE, THIEF, SUCKER_PUNCH
	dw 0 ; OT ID
	bigdt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db PINSIR
	db GOLD_BERRY
	db HYPER_BEAM, DRILL_PECK, STRENGTH, TOXIC
	dw 0 ; OT ID
	bigdt 512000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 9
	...
	db UMBREON
	db KINGS_ROCK
	db FAINT_ATTACK, SUCKER_PUNCH, MOONLIGHT, CONFUSE_RAY
	dw 0 ; OT ID
	bigdt 729000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db MACHAMP
	db QUICK_CLAW
	db CROSS_CHOP, CROSS_CHOP, FIRE_BLAST, EARTHQUAKE
	dw 0 ; OT ID
	bigdt 729000 ; Exp
	; Stat exp
	bigdw 55000
...
; BattleTowerMons group 10
	...
	db MACHAMP
	db QUICK_CLAW
	db CROSS_CHOP, EARTHQUAKE, HYPER_BEAM, CROSS_CHOP
	dw 0 ; OT ID
	bigdt 1000000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db FEAROW
	db KINGS_ROCK
	db DRILL_PECK, STEEL_WING, HYPER_BEAM, SUCKER_PUNCH
	dw 0 ; OT ID
	bigdt 1000000 ; Exp
	; Stat exp
	bigdw 55000
