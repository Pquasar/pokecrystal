...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move CLEAR_SMOG,   EFFECT_CLEAR_SMOG,         50, POISON,        SPECIAL,  100, 40,   0
	...
	move FREEZE_DRY,   EFFECT_FREEZE_HIT,         70, FREEZEDRY,     SPECIAL,  100, 32,  10
	...
	move COSMIC_POWER, EFFECT_STOCKPILE,           0, PSYCHIC_TYPE,  STATUS,   100, 32,   0
	move DUAL_CHOP,    EFFECT_DOUBLE_HIT,         40, DRAGON,        PHYSICAL,  90, 24,   0
	move ICICLE_CRASH, EFFECT_FLINCH_HIT,         85, ICE,           PHYSICAL,  90, 16,  30
	move DISABLE,      EFFECT_DISABLE,             0, NORMAL,        STATUS,   100, 32,   0
	move POWER_WHIP,   EFFECT_NORMAL_HIT,        120, GRASS,         PHYSICAL,  85, 16,   0
	move DRAIN_PUNCH,  EFFECT_LEECH_HIT,          75, FIGHTING,      PHYSICAL, 100, 16,  10
	move FLAMETHROWER, EFFECT_BURN_HIT,           90, FIRE,          SPECIAL,  100, 24,  10
	move MIST,         EFFECT_MIST,                0, ICE,           STATUS,   100, 40,   0
	move AURA_SPHERE,  EFFECT_ALWAYS_HIT,         80, FIGHTING,      SPECIAL,  100, 32,   0
	...
	move DAZLINGGLEAM, EFFECT_NORMAL_HIT,         80, FAIRY,         SPECIAL,  100, 16,   0
	move DRILL_PECK,   EFFECT_NORMAL_HIT,         80, FLYING,        PHYSICAL, 100, 32,   0
	move DARK_PULSE,   EFFECT_FLINCH_HIT,         80, DARK,          SPECIAL,  100, 24,  20
	...
	move BULLDOZE,     EFFECT_SPEED_DOWN_HIT,     60, GROUND,        SPECIAL,  100, 32, 100
	move OVERHEAT,     EFFECT_OVERHEAT,          130, FIRE,          SPECIAL,   90,  8,   0
	...
	move CROSS_POISON, EFFECT_POISON_HIT,         70, POISON,        PHYSICAL, 100, 32,  10
	...
	move SEED_BOMB,    EFFECT_NORMAL_HIT,         80, GRASS,         PHYSICAL, 100, 24,   0
	move SLUDGE,       EFFECT_POISON_HIT,         65, POISON,        SPECIAL,  100, 32,  30 ; can remove
	move AQUA_TAIL,    EFFECT_NORMAL_HIT,         90, WATER,         PHYSICAL,  90, 16,   0
	...
	move EXTRASENSORY, EFFECT_FLINCH_HIT,         80, PSYCHIC_TYPE,  SPECIAL,  100, 32,  10
	...
	move ZEN_HEADBUTT, EFFECT_FLINCH_HIT,         80, PSYCHIC_TYPE,  PHYSICAL,  90, 24,  20
	...
	move ICE_SHARD,    EFFECT_PRIORITY_HIT,       40, ICE,           PHYSICAL, 100, 40,   0
	...
	move STONE_EDGE,   EFFECT_NORMAL_HIT,        100, ROCK,          PHYSICAL,  80,  8,   0
	...
	move STOCKPILE,    EFFECT_STOCKPILE,           0, NORMAL,        STATUS,   100, 32,   0
	move REVERSAL,     EFFECT_REVERSAL,            1, FIGHTING,      PHYSICAL, 100, 24,   0
	move WILL_O_WISP,  EFFECT_BURN,                0, FIRE,          STATUS,    85, 24,   0
	move EARTH_POWER,  EFFECT_SP_DEF_DOWN_HIT,    90, GROUND,        SPECIAL,  100, 16,  10
	...
	move ENERGY_BALL,  EFFECT_SP_DEF_DOWN_HIT,    90, GRASS,         SPECIAL,  100, 16,  10
	...
	move BUG_BUZZ,     EFFECT_SP_DEF_DOWN_HIT,    90, BUG,           SPECIAL,  100, 16,  10
	move LIQUIDATION,  EFFECT_DEFENSE_DOWN_HIT,   85, WATER,         PHYSICAL, 100, 16,  20
	...
	move IRON_DEFENSE, EFFECT_DEFENSE_UP_2,        0, STEEL,         STATUS,   100, 24,   0
	...
	move ROOST,        EFFECT_HEAL,                0, FLYING,        STATUS,   100,  8,   0
	move U_TURN,       EFFECT_U_TURN,             70, BUG,           PHYSICAL, 100, 32,   0
	...
	move DRAGON_DANCE, EFFECT_DRAGON_UP,           0, DRAGON,        STATUS,   100, 32,   0
	...
	move SIGNAL_BEAM,  EFFECT_CONFUSE_HIT,        75, BUG,           SPECIAL,  100, 24,  10
