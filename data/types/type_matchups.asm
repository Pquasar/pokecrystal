TypeMatchups:
	...
	db FREEZEDRY,    WATER,        SUPER_EFFECTIVE
	db FREEZEDRY,    GRASS,        SUPER_EFFECTIVE
	db FREEZEDRY,    ICE,          NOT_VERY_EFFECTIVE
	db FREEZEDRY,    GROUND,       SUPER_EFFECTIVE
	db FREEZEDRY,    FLYING,       SUPER_EFFECTIVE
	db FREEZEDRY,    DRAGON,       SUPER_EFFECTIVE
	db FREEZEDRY,    STEEL,        NOT_VERY_EFFECTIVE
	db FREEZEDRY,    FIRE,         NOT_VERY_EFFECTIVE
