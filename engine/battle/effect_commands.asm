...
.Traps:
	...
	dbw INFESTATION, InfestedByText    ; 'was INFESTED by'
...
BattleCommand_DoubleAcrobatics:
	ldh a, [hBattleTurn]
	and a
	ld hl, wBattleMonItem
	jr z, .got_item
